...
<br>
	...
	<form:form action="save" method="POST" commandName="category" class="form-horizontal" role="form" >
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<form:input path="id" hidden="true" placeholder="Enter the id" class="form-control" required="TRUE" title="should not be empty" />
			</div>
		</div>
		<div class="form-group">
	...
	<div class="form-group">
		...
		<br>
		<br>
			<button type="submit" class="btn btn-info .btn-sm"> Add <a href=http://yoursmiles.org/t-dogs.php?page=4>
			<img src=http://yoursmiles.org/tsmile/dogs/t0482.gif></a></button> 
