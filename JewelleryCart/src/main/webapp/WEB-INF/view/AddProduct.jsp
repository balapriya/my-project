...
<br>
	...
	<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<form:input path="productcategory" placeholder="Enter category" class="form-control" required="TRUE" title="should not be empty" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label">ProductSupplier:</label>
			<div class="col-sm-6">
				<form:input path="productsupplier" placeholder="Enter supplier" class="form-control" required="TRUE" title="should not be empty" />
			</div>
		</div> 
		
		<div class="form-group">
		<label for="file">UPLOAD FILE</label>
		<form:input type="file" path="Image" id="file" class="form-control"/>
		</div> 
...
<center>
		<br>
		<br>
			<button type="submit" class="btn btn-info .btn-sm">Add<a href=http://yoursmiles.org/t-dogs.php?page=4><img src=http://yoursmiles.org/tsmile/dogs/t0482.gif></a></button>
